...
public class LOGIN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("HỆ THỐNG QUẢN LÝ SÁCH THƯ VIỆN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        char[] data = txtMatKhau.getPassword();
        String pass = String.valueOf(data);
        if(n.getTaiKhoan().equalsIgnoreCase(txtTaiKhoan.getText()) && n.getMatKhau().equalsIgnoreCase(pass)){
